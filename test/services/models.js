...
describe('Unit: Base Service', function () {
    var PATHS, Service, $q, temp, obj, index;
    ...
    // Test Models
    for(index in models){
        testServiceModel(models[index]);
    }

    function testServiceModel(_service_){

        beforeEach(inject(function (_PATHS_, _$q_, $injector) {
            Service = $injector.get(_service_);
            PATHS = _PATHS_;
            $q = _$q_;
            temp = Service.ctrl;
        ...
        it('should have expected api host', function(){
